    ...
    <div class="d-flex flex-column flex-root">
        ...
        <div class="d-flex flex-row flex-column-fluid page">
                    ...
                    <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
                        ...
                        <ul class="menu-nav">
                            <li class="menu-item menu-item-active" aria-haspopup="true">
                                <a href="/apps/dashboard" class="menu-link">
                            ...
                            <li class="menu-item" aria-haspopup="true">
                                <a href="/apps/rapat" class="menu-link">
                                    <span class="svg-icon menu-icon">
                                        <!--begin::Svg Icon | path:/adminpi/dist/assets/media/svg/icons/Design/Layers.svg-->
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                            viewBox="0 0 24 24" version="1.1">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    ...
                                    <span class="menu-text">Manajament Rapat</span>
                                </a>
                            </li>
                            <li class="menu-item" aria-haspopup="true">
                                <a href="/apps/ruangan" class="menu-link">
                                    <span class="svg-icon menu-icon">
                                        <!--begin::Svg Icon | path:/adminpi/dist/assets/media/svg/icons/Design/Layers.svg-->
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                            ...
                            <li class="menu-section">
                                <h4 class="menu-text">Users Manajement</h4>
                                <i class="menu-icon ki ki-bold-more-hor icon-md"></i>
                            </li>
                            @if(Auth::user()->hasAnyPermission('roles.index'))
                            <li class="menu-item" aria-haspopup="true">
                                <a href="{{route('apps.roles.index')}}" class="menu-link">
                                    <span class="svg-icon menu-icon">
                            ...
                            @endif
                            {{-- jika permission index --}}
                            @if(Auth::user()->hasAnyPermission('permissions.index'))
                            <li class="menu-item" aria-haspopup="true">
                                <a href="{{route('apps.permissions.index')}}" class="menu-link">
                                    <span class="svg-icon menu-icon">
                            ...
                            @endif
                            @if(Auth::user()->hasAnyPermission('users.index'))
                            <li class="menu-item" aria-haspopup="true">
                                <a href="{{route('apps.users.index')}}" class="menu-link">
                                    <span class="svg-icon menu-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                            viewBox="0 0 24 24" version="1.1">
            ...
            <div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
                ...
                <!--end::Header-->
                <!--begin::Content-->
                <div class="content d-flex flex-column flex-column-fluid py-2 py-lg-4" id="kt_content">
                    @yield('content')
                </div>
                <!--end::Content-->
                <!--begin::Footer-->
