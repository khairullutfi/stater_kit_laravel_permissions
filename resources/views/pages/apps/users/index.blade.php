...
<div class="card card-custom">
    <div class="card-header">
        ...
        <div class="card-toolbar">
            ...
            <a href="{{route('apps.users.create')}}" class="btn btn-primary font-weight-bolder">
                <span class="svg-icon svg-icon-md">
...
<script>
    var datatable = $('#crudTable').dataTable({
            ...
            // defaultContent onclick delete button
        ...
        function deleteData(id) {
            swal.fire({
              title: 'Are you sure?',
                ...
                if (result.value) {
                    $.ajax({
                        url: "{{ route('apps.users.destroy', ':id') }}".replace(':id', id),
                        type: "POST",
                        data: {
                            "_token": "{{ csrf_token() }}",
                            "_method": "DELETE"
